    ...
    def __init__(self):
        ...
        self.translations: Dict[str, Dict[str, str]] = {
            "zh_CN": {
                ...
                "settings_output_device": "音频输出",
                "tray_hide_icon": "隐藏托盘图标 (HA 中可恢复)",
                "tray_hide_switch": "隐藏图标",
                "wake_word_sensitivity": "唤醒词灵敏度",
                "settings_default_device": "系统默认",
                "mute_microphone": "静音麦克风",
                "unmute_microphone": "取消静音",
                "conversation_bubbles": "显示对话气泡",
                "sendspin_player": "Sendspin 播放器",
                "sendspin_enabled": "启用 Sendspin 播放器",
                "sendspin_connected": "已连接",
                "sendspin_disconnected": "未连接",
                "sendspin_not_available": "Sendspin 不可用",
                "sendspin_pairing_title": "Sendspin 配对",
                "sendspin_pairing_pin_prompt": "请在 Music Assistant 中输入此配对码",
                "sendspin_pairing_pin_copied": "配对码已复制，可直接粘贴",
                "sendspin_pairing_mismatch_title": "配对不匹配",
                ...
                "close": "关闭",
                "about_title": "关于",
                "about_description": "Windows 原生 Home Assistant 语音助手客户端",
                "about_copyright": "© 2024 ha-china",
                "ready": "准备就绪",
            ...
            "en_US": {
                ...
                "settings_output_device": "Audio Output",
                "tray_hide_icon": "Hide Tray Icon (restore in HA)",
                "tray_hide_switch": "Hide Icon",
                ...
                "sendspin_player": "Sendspin Player",
                "sendspin_enabled": "Enable Sendspin Player",
                "sendspin_connected": "Connected",
                "sendspin_disconnected": "Not connected",
                "sendspin_not_available": "Sendspin unavailable",
                "sendspin_pairing_title": "Sendspin Pairing",
                "sendspin_pairing_pin_prompt": "Enter this PIN in Music Assistant",
                "sendspin_pairing_pin_copied": "PIN copied - paste it directly",
                "sendspin_pairing_mismatch_title": "Pairing Mismatch",
                ...
                "close": "Close",
                "about_title": "About",
                "about_description": "Windows native client for Home Assistant voice assistant",
                "about_copyright": "© 2024 ha-china",
                "ready": "Ready",
